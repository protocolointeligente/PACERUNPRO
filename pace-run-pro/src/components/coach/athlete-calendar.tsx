...
const WO_CONFIG: Record<string, { label: string; short: string; bg: string; dot: string }> = {
  ...
  LONGAO:            { label: "Longão",              short: "L",  bg: "bg-indigo-500",  dot: "#6366f1" },
  ...
  TEMPO_RUN:         { label: "Tempo Run",           short: "T4", bg: "bg-orange-500",  dot: "#f97316" },
  ...
  FORCA:             { label: "Força",               short: "FC", bg: "bg-violet-500",  dot: "#8b5cf6" },
  FUNCIONAL:         { label: "Funcional",           short: "FN", bg: "bg-purple-500",  dot: "#a855f7" },
