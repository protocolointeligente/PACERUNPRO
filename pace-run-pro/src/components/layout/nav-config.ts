...
export const athleteMoreNav: NavItem[] = [
  ...
  { href: "/marketplace",          label: "Marketplace",           icon: Store,       sectionStart: "Comprar"    },
  { href: "/atleta/compras",      label: "Minhas compras",        icon: ShoppingBag                             },
  { href: "/atleta/afiliados",    label: "Programa de afiliados", icon: Share2                                  },
  { href: "/atleta/loja",          label: "Loja de treinos",       icon: PackagePlus                             },
...
export const coachNav: NavItem[] = [
  ...
  { href: "/treinador/marketplace/produtos",        label: "Meus produtos",           icon: Package                             },
  { href: "/treinador/marketplace/pedidos",         label: "Pedidos",                 icon: Receipt                             },
  { href: "/treinador/marketplace/financeiro",      label: "Financeiro",              icon: DollarSign                          },
  { href: "/treinador/marketplace/afiliados",       label: "Programa de afiliados",   icon: Share2                              },
  { href: "/treinador/marketplace/cupons",          label: "Cupons de desconto",      icon: Tag                                 },
  { href: "/treinador/marketplace/conectar",        label: "Conectar pagamentos",     icon: Link2                               },
  { href: "/treinador/marketplace/configurar-loja", label: "Configurar loja",         icon: Settings                            },
...
export const adminNav: NavItem[] = [
  ...
  { href: "/admin/marketplace/moderar",    label: "Moderar produtos",  icon: ShieldCheck     },
  { href: "/admin/marketplace/payouts",    label: "Repasses coaches",  icon: DollarSign      },
  { href: "/admin/marketplace/auditoria",  label: "Auditoria",         icon: ScrollText      },
