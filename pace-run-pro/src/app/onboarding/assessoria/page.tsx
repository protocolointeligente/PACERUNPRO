          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <span
              className={[
                ...
                s === current ? "text-white" : "text-text-muted",
              ].join(" ")}
            >
              {labels[s - 1]}
            </span>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="space-y-5 lg:col-span-2">
              ...
              <div className="border-t border-border pt-5">
                <p className="mb-4 text-sm font-semibold text-white">Responsável pela conta</p>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="space-y-6 lg:col-span-2">
              ...
              <div className="rounded-2xl border border-border bg-card p-6">
                <p className="mb-4 text-sm font-semibold text-white">Resumo do cadastro</p>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-text-muted">Assessoria</span>
                    <span className="font-medium text-white">{nomeAssessoria || "—"}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-white">R$ {plan.price}/mês</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-muted">Treinador responsável</span>
                    <span className="font-medium text-white">{nomeCoach || "—"}</span>
                  </div>
                </div>
              </div>
