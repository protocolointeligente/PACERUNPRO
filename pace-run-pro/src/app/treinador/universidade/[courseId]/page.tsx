...
export default function TreinadorCourseDetailPage({
  params,
}: {
  ...
  if (!course || (course.for !== "coach" && course.for !== "both")) {
    notFound();
  }
            ...
            >
              ...
              <AnimatePresence>
                {isOpen && (
                  ...
                  >
                    <div
                      className="px-4 pb-5 pt-1 text-sm leading-relaxed"
