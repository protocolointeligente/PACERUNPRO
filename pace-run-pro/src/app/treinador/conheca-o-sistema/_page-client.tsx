    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <motion.div custom={1} variants={fadeUp} initial="hidden" animate="show">
        <Tabs defaultValue="comecando">
          ...
          <TabsContent value="metricas" className="space-y-5">
            <Card>
              <CardContent className="p-5 space-y-1">
                ...
                <MetricRow
                  ...
                  description="Méodo de Foster: quantifica a carga de uma sessão multiplicando sua duração total em minutos pelo RPE registrado após o treino. Exemplo: 60 min com RPE 7 = 420 UA. É a base de todos os cálculos de carga no sistema."
                />
                <MetricRow
                  abbr="CTL"
            ...
            <Card>
              <CardContent className="p-5 space-y-1">
                ...
                <MetricRow
                  ...
                  description="Receita recorrente mensal da sua assessoria: soma de todos os atletas pagantes × valor do plano. Exibido no painel de Gestão & vendas (disponível no plano Starter+). Inclui receita da loja de planilhas separada do MRR de mensalidades."
                />
                <MetricRow
                  abbr="Deload"
