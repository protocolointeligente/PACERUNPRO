...
import MinhaPaginaClient from "./_minha-pagina-client";
...
export default async function MinhaPaginaPage() {
  ...
  if (!canAccess("owner", "minha-pagina", planId)) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-24 text-center">
        <p className="text-lg font-semibold text-text">Recurso não disponível no seu plano</p>
        <p className="text-sm text-text-muted">
          Faça upgrade para o plano Starter ou superior para usar Minha Página Pública.
        </p>
        <a
