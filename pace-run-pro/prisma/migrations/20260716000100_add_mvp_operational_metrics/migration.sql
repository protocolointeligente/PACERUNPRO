...
ALTER TABLE "generation_batches"
  ADD COLUMN IF NOT EXISTS "coachId" TEXT NOT NULL,
  ADD COLUMN IF NOT EXISTS "athleteId" TEXT NOT NULL,
  ADD COLUMN IF NOT EXISTS "planId" TEXT,
  ADD COLUMN IF NOT EXISTS "source" TEXT NOT NULL DEFAULT 'periodization',
...
ALTER TABLE "workout_feedbacks"
  ADD COLUMN IF NOT EXISTS "workoutId" TEXT NOT NULL,
  ADD COLUMN IF NOT EXISTS "athleteId" TEXT NOT NULL,
  ...
  ADD COLUMN IF NOT EXISTS "avgHr" INTEGER,
  ADD COLUMN IF NOT EXISTS "maxHr" INTEGER,
  ADD COLUMN IF NOT EXISTS "rpe" INTEGER,
  ADD COLUMN IF NOT EXISTS "sessionRpeLoad" DOUBLE PRECISION,
  ...
  ADD COLUMN IF NOT EXISTS "painLocation" TEXT,
  ADD COLUMN IF NOT EXISTS "painIntensity" INTEGER,
...
ALTER TABLE "derived_metrics"
  ...
  ADD COLUMN IF NOT EXISTS "label" TEXT NOT NULL DEFAULT 'Métrica',
  ADD COLUMN IF NOT EXISTS "value" DOUBLE PRECISION,
  ADD COLUMN IF NOT EXISTS "textValue" TEXT,
  ADD COLUMN IF NOT EXISTS "unit" TEXT,
  ADD COLUMN IF NOT EXISTS "scope" "MetricScope" NOT NULL DEFAULT 'WEEKLY',
  ADD COLUMN IF NOT EXISTS "source" "MetricSource" NOT NULL DEFAULT 'SYSTEM',
  ADD COLUMN IF NOT EXISTS "confidence" DOUBLE PRECISION,
...
ALTER TABLE "audit_logs"
  ...
  ADD COLUMN IF NOT EXISTS "athleteId" TEXT,
  ADD COLUMN IF NOT EXISTS "action" "AuditAction" NOT NULL DEFAULT 'CREATE',
